  ...
  const handleTranslateAll = async () => {
    ...
    const translateChapter = async (chapter, index, workerId) => {
      ...
      try {
        ...
        console.error(`[StoryTranslator] ❌ Exception khi dịch chương ${chapter.title}:`, error2);
        return null;
      } finally {
        setProcessingChapters((prev) => {
          const next = new Map(prev);
...
Số chương: ${ebookChapters.length}`);
      ...
      console.error("[StoryTranslator] Lỗi export ebook:", error2);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-screen p-6 gap-4 max-w-7xl mx-auto w-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold text-primary", children: "Dịch Truyện AI" }),
      chapters.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm px-3 py-1 bg-primary/10 text-primary rounded-full", children: [
          "Đã dịch: ",
        ...
        translatedChapters.size > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
...
function StoryTranslatorWeb() {
  ...
  const [chapters, setChapters] = reactExports.useState([]);
  const [translatedChapters, setTranslatedChapters] = reactExports.useState(/* @__PURE__ */ new Map());
  const [processingTimes, setProcessingTimes] = reactExports.useState(/* @__PURE__ */ new Map());
  const [viewMode, setViewMode] = reactExports.useState("original");
  const [excludedChapterIds, setExcludedChapterIds] = reactExports.useState(/* @__PURE__ */ new Set());
  const [batchProgress, setBatchProgress] = reactExports.useState(null);
  ...
  const [sessionContext, setSessionContext] = reactExports.useState(null);
  const stopRef = reactExports.useRef(false);
  const [waitingTime, setWaitingTime] = reactExports.useState(0);
  ...
  const updateBrowserConfig = async (configId, configs) => {
    try {
      let configData;
      if (configs) {
  ...
  const selectAllChapters = () => setExcludedChapterIds(/* @__PURE__ */ new Set());
  ...
  const parseFile = async (path) => {
    ...
    try {
      ...
      console.error("Loi parse:", error2);
    } finally {
      setStatus("idle");
    }
  };
  const handleTranslate = async () => {
    ...
    try {
      ...
      alert(`Lỗi dịch: ${error2}`);
    } finally {
      setStatus("idle");
    }
  };
  const [packInterval, setPackInterval] = reactExports.useState(0);
  const createEbook = async (chaptersToPack, suffix) => {
    try {
  ...
  const handleTranslateAll = async () => {
      ...
      try {
        ...
        if (prepareResult.success && prepareResult.prompt) {
          ...
          timerRef.current = setInterval(() => {
            setWaitingTime(Math.floor((Date.now() - startTime) / 1e3));
          }, 1e3);
          const translateResult = await window.electronAPI.invoke(STORY_IPC_CHANNELS.TRANSLATE_CHAPTER, {
            prompt: prepareResult.prompt,
            method: "WEB",
        ...
        console.error(`[StoryTranslator] Error:`, error2);
        if (timerRef.current) {
          clearInterval(timerRef.current);
          timerRef.current = null;
        }
    ...
    if (packInterval === -1 && !stopRef.current) {
      const finalChapters = [];
      for (const chapter of chapters) {
        let content2 = sessionMap.get(chapter.id);
        if (!content2) content2 = translatedChapters.get(chapter.id);
        if (content2) finalChapters.push({ ...chapter, content: content2 });
      }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-screen p-6 gap-4 max-w-7xl mx-auto w-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-2xl font-bold text-primary flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(MessageSquare, { className: "w-8 h-8" }),
        "Dịch Truyện (Google Web)"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 items-center", children: [
        selectedBrowserConfig && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs px-2 py-1 bg-blue-50 text-blue-700 rounded border border-blue-200 flex items-center gap-1", title: selectedBrowserConfig.userAgent || "Chưa có User-Agent", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: resetSession, variant: "secondary", className: "text-xs h-8", children: "Reset Session" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            onClick: () => {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Settings$1, { size: 14 }),
              "Cài đặt"
            ]
          }
        )
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-12 gap-4 p-4 bg-card border border-border rounded-xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-4 flex flex-col gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium", children: "File Truyện" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: filePath, readOnly: true, placeholder: "Chọn file...", containerClassName: "flex-1" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: handleBrowse, variant: "secondary", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { size: 16 }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-3 relative group", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Select,
          {
            label: "Cấu hình Web",
        ...
        selectedBrowserConfig && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute right-2 top-9 flex items-center gap-1 pointer-events-none", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Monitor, { size: 14, className: "text-muted-foreground" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: selectedBrowserConfig.platform || "Auto" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Select, { label: "Đóng gói Ebook", value: packInterval, onChange: (e) => setPackInterval(Number(e.target.value)), options: PACK_OPTIONS }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Select, { label: "Ngôn ngữ gốc", value: sourceLang, onChange: (e) => setSourceLang(e.target.value), options: LANG_OPTIONS }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Select, { label: "Ngôn ngữ đích", value: targetLang, onChange: (e) => setTargetLang(e.target.value), options: LANG_OPTIONS }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2 flex items-end gap-2 col-start-11 md:col-start-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: handleTranslate, disabled: !selectedChapterId || status === "running", className: "flex-1", title: "Dịch chương hiện tại", children: "Dịch 1" }),
        status === "running" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: handleStop, variant: "danger", className: "flex-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Ban, { size: 16, className: "mr-1" }),
          " Dừng (",
          batchProgress ? `${batchProgress.current}/${batchProgress.total}` : "",
          ")"
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: handleTranslateAll, variant: "primary", disabled: !selectedChapterId || status === "running", className: "flex-1", title: "Dịch toàn bộ", children: "Dịch All" })
      ] }),
      status === "running" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-12 flex items-center gap-4 px-3 py-2 bg-surface/50 border border-border rounded-lg text-sm", children: isWaitingResponse ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { size: 16, className: "animate-spin text-primary" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "Đang chờ phản hồi..." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono text-primary font-semibold", children: [
          waitingTime,
          "s"
        ] })
      ] }) : cooldownTime > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { size: 16, className: "text-warning" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "Chờ trước khi dịch chương tiếp theo:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono text-warning font-semibold", children: [
          cooldownTime,
          "s"
        ] })
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { size: 16, className: "text-success" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-success", children: "Sẵn sàng dịch chương tiếp theo..." })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex gap-4 min-h-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-1/4 bg-card border border-border rounded-xl flex flex-col", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 border-b flex justify-between items-center bg-surface/50", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: selectAllChapters, className: "p-1 hover:bg-primary/10 rounded", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SquareCheckBig, { size: 14 }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: deselectAllChapters, className: "p-1 hover:bg-primary/10 rounded", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Square, { size: 14 }) })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto p-2 space-y-1", children: chapters.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            onClick: () => {
              setSelectedChapterId(c.id);
              setViewMode(translatedChapters.has(c.id) ? "translated" : "original");
            },
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  onClick: (e) => {
                    e.stopPropagation();
                    toggleChapterExclusion(c.id);
                  },
                  className: `w-4 h-4 border rounded flex items-center justify-center ${isChapterIncluded(c.id) ? "bg-current" : "border-gray-400"}`,
                  children: isChapterIncluded(c.id) && /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { size: 10, className: selectedChapterId === c.id ? "text-primary" : "text-white" })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `truncate text-sm flex-1 ${!isChapterIncluded(c.id) && "opacity-50 line-through"}`, children: c.title }),
              processingTimes.has(c.id) && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] text-gray-400 font-mono", children: [
                (processingTimes.get(c.id) / 1e3).toFixed(1),
                "s"
              ] }),
              translatedChapters.has(c.id) && /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { size: 14, className: "text-green-400" })
            ]
          },
          c.id
        )) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 bg-card border border-border rounded-xl flex flex-col", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 border-b flex justify-between items-center bg-surface/50", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: viewMode === "original" ? "primary" : "secondary", onClick: () => setViewMode("original"), className: "text-xs h-7 px-3", children: "Gốc" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: viewMode === "translated" ? "primary" : "secondary", onClick: () => setViewMode("translated"), disabled: !selectedChapterId || !translatedChapters.has(selectedChapterId), className: "text-xs h-7 px-3", children: "Bản Dịch" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium", children: chapters.find((c) => c.id === selectedChapterId)?.title })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto p-6 text-lg leading-relaxed whitespace-pre-wrap", children: selectedChapterId ? viewMode === "original" ? chapters.find((c) => c.id === selectedChapterId)?.content : translatedChapters.get(selectedChapterId) || "Chưa dịch" : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center text-gray-400 mt-20", children: "Chọn chương để xem" }) })
      ] })
    ] })
  ] });
}
function GeminiChat() {
  ...
  const [useContext, setUseContext] = reactExports.useState(true);
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-6 py-4 border-b border-border", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          activeSession?.convId && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs bg-surface-hover px-2 py-1 rounded border border-border text-text-secondary font-mono", children: [
              "ID: ",
              activeSession.convId
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-2 text-xs text-text-primary cursor-pointer select-none", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  type: "checkbox",
...
function ApiKeysSettings({ onBack }) {
  ...
  const toggleErrorMessage = (projectKey) => {
  ...
  const getStatusConfig = (status) => {
    const configs = {
      "available": { bg: "#10b98120", text: "#10b981", label: "Sẵn sàng", icon: CircleCheckBig },
      "rate_limited": { bg: "#f59e0b20", text: "#f59e0b", label: "Giới hạn tốc độ", icon: Clock },
      "exhausted": { bg: "#6366f120", text: "#6366f1", label: "Hết quota", icon: CircleX },
      "error": { bg: "#ef444420", text: "#ef4444", label: "Lỗi", icon: CircleAlert }
    };
    return configs[status] || configs["available"];
  };
  const totalProjects = apiAccounts.reduce((sum, acc) => sum + acc.projects.length, 0);
  const availableProjects = apiAccounts.reduce(
    (sum, acc) => sum + acc.projects.filter((p) => p.status === "available").length,
    0
  );
  const totalSuccess = apiAccounts.reduce(
    (sum, acc) => sum + acc.projects.reduce((s, p) => s + (p.successCount || 0), 0),
    0
  );
  const totalErrors = apiAccounts.reduce(
    (sum, acc) => sum + acc.projects.reduce((s, p) => s + (p.errorCount || 0), 0),
    0
  );
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.detailContainer, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.detailHeader, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "secondary", iconOnly: true, onClick: onBack, title: "Quay lại", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeft, { size: 20 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.detailTitle, children: "Quản lý API Keys" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.detailContent, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.section, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.row, children: [
        ...
        !loading && apiAccounts.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
          display: "grid",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "0.75em", color: "var(--text-secondary)", marginBottom: 4 }, children: "Tổng tài khoản" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "1.5em", fontWeight: 700, color: "var(--text-primary)" }, children: apiAccounts.length })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
            background: "var(--bg-secondary)",
            borderRadius: 8,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "0.75em", color: "var(--text-secondary)", marginBottom: 4 }, children: "Keys sẵn sàng" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontSize: "1.5em", fontWeight: 700, color: "#10b981" }, children: [
              availableProjects,
              "/",
              totalProjects
            ] })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "0.75em", color: "var(--text-secondary)", marginBottom: 4 }, children: "Tổng thành công" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "1.5em", fontWeight: 700, color: "#10b981" }, children: totalSuccess.toLocaleString() })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
            background: "var(--bg-secondary)",
            borderRadius: 8,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "0.75em", color: "var(--text-secondary)", marginBottom: 4 }, children: "Tổng lỗi" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "1.5em", fontWeight: 700, color: totalErrors > 0 ? "#ef4444" : "var(--text-tertiary)" }, children: totalErrors.toLocaleString() })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.divider, style: { margin: "16px 0", borderTop: "1px solid var(--border-color)" } }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.row, style: { display: "block" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.label, style: { marginBottom: 12 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles.labelText, children: "Danh sách tài khoản" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
            ...
            maxHeight: 450,
            overflowY: "auto"
          }, children: loading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", padding: 40, color: "var(--text-secondary)" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { size: 24, style: { animation: "spin 1s linear infinite" } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginTop: 8 }, children: "Đang tải..." })
          ] }) : apiAccounts.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", padding: 40, color: "var(--text-secondary)" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { size: 32, style: { opacity: 0.5, marginBottom: 8 } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginBottom: 4 }, children: "Chưa có API key nào" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "0.85em" }, children: 'Nhấn "Import" để thêm keys từ file JSON' })
          ] }) : apiAccounts.map((acc, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
            marginBottom: 8,
            padding: 10,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontWeight: 600, fontSize: "0.9em" }, children: acc.email }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
                fontSize: "0.75em",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexDirection: "column", gap: 4 }, children: acc.projects.map((p, pIndex) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(StatusIcon, { size: 11 }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: statusConfig.label })
                  ] }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 4, fontSize: "0.85em" }, children: [
                  ...
                  p.totalRequestsToday > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: {
                    background: "var(--bg-primary)",
                    color: "var(--text-secondary)",
                    padding: "2px 6px",
                    borderRadius: 3,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: {
                    ...
                    borderRadius: 2,
                    whiteSpace: "nowrap"
                  }, children: formatTimestamp(p.lastUsedTimestamp) })
                ] }),
                hasError && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginTop: 4 }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      ...
                      children: [
                        isErrorExpanded ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { size: 10 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { size: 10 }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { flex: 1, fontWeight: 500 }, children: isErrorExpanded ? "Ẩn lỗi" : "Xem lỗi" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { size: 10 })
                      ]
                    }
                  ),
                  isErrorExpanded && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
                    marginTop: 3,
                    padding: 6,
                    background: "var(--bg-primary)",
                    borderRadius: 3,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.saveBar, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: () => loadApiKeysInfo(), variant: "secondary", disabled: loading, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(RotateCcw, { size: 16 }),
        "Làm mới"
      ] }) })
    ] }),
...
function GeminiChatSettings({ onBack }) {
  ...
  const loadConfigs = reactExports.useCallback(async () => {
    try {
      ...
      console.error("Error loading configs:", error2);
      setErrorMessage(String(error2));
    } finally {
      setIsLoading(false);
    }
  }, []);
  ...
  const handleToggleActive = async (config, e) => {
    e.stopPropagation();
    try {
      ...
      console.error("Error toggling active:", error2);
    }
  };
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.detailContainer, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.detailContent, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-4", children: [
          ...
          configs.length === 0 && !isLoading && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center py-20 text-gray-400", children: 'Chưa có tài khoản nào. Nhấn "Thêm mới" để cấu hình.' })
        ] })
      ] })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.detailContainer, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.detailHeader, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "secondary", iconOnly: true, onClick: () => setMode("list"), title: "Quay lại", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeft, { size: 20 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.detailTitle, children: mode === "create" ? "Thêm tài khoản mới" : "Chỉnh sửa tài khoản" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.detailContent, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.section, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.row, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.label, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles.labelText, children: "Tên cấu hình" }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.section, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.row, style: { display: "block" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.label, style: { marginBottom: 8 }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles.labelDesc, children: "Dán headers/curl từ DevTools để tự động điền các trường bên dưới" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "textarea",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4 items-center mt-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: handleAutoParse, variant: "primary", className: "h-8 text-xs", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { size: 14, className: "mr-1" }),
            " Phân tích"
          ] }),
          parseStatus && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-green-600", children: parseStatus })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.section, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.row, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-medium text-sm flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Globe, { size: 14 }),
              " BL_LABEL"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-500", children: "Từ URL parameter bl=..." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: formData.blLabel, onChange: (e) => setFormData({ ...formData, blLabel: e.target.value }), containerClassName: "w-1/2" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.row, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-medium text-sm flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Hash, { size: 14 }),
              " F_SID"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-500", children: "Từ URL parameter f.sid=..." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: formData.fSid, onChange: (e) => setFormData({ ...formData, fSid: e.target.value }), containerClassName: "w-1/2" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.row, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-medium text-sm flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-500", children: "Từ Body parameter at=..." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: formData.atToken, onChange: (e) => setFormData({ ...formData, atToken: e.target.value }), containerClassName: "w-1/2" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.section, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.row, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-medium text-sm flex items-center gap-2", children: [
              ...
              " Chọn preset trình duyệt"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-500", children: "Chọn preset sẽ tự động điền thông tin bên dưới" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "select",
            {
              ...
              className: styles.select,
              children: BROWSER_PRESETS.map((preset, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: idx, children: preset.label }, idx))
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.row, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-sm", children: "Platform / OS" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-500", children: "Hệ điều hành giả lập" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "select",
            {
              ...
              className: styles.select,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Windows", children: "Windows" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "macOS", children: "macOS" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Linux", children: "Linux" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Android", children: "Android" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "iOS", children: "iOS" })
              ]
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.row, style: { display: "block" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-2 font-medium text-sm", children: "User Agent" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "textarea",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.row, style: { display: "block" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-2 font-medium text-sm", children: "Accept-Language" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: formData.acceptLanguage, onChange: (e) => setFormData({ ...formData, acceptLanguage: e.target.value }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.saveBar, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "secondary", onClick: () => setMode("list"), disabled: isLoading, children: "Hủy" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: handleSave, variant: "primary", disabled: isLoading, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Save, { size: 16, className: "mr-2" }),
...
function ProxySettings() {
  ...
  const [bulkImportText, setBulkImportText] = reactExports.useState("");
  const [formData, setFormData] = reactExports.useState({
    host: "",
    port: 8080,
    username: "",
  ...
  const loadProxies = async () => {
    try {
      ...
      console.error("Lỗi load proxies:", error2);
    } finally {
      setLoading(false);
    }
  };
  const loadStats = async () => {
    try {
      ...
      console.error("Lỗi load stats:", error2);
    }
  };
  const loadProxySetting = async () => {
    try {
      ...
      console.error("Lỗi load proxy setting:", error2);
    }
  };
  const handleToggleUseProxy = async (enabled) => {
    try {
      ...
      console.error("Lỗi toggle proxy:", error2);
    }
  };
  const handleAddProxy = async () => {
    try {
      ...
      console.error("Lỗi add proxy:", error2);
  ...
  const handleRemoveProxy = async (id) => {
    ...
    try {
      ...
      console.error("Lỗi remove proxy:", error2);
      alert("Lỗi xóa proxy!");
    }
  };
  const handleToggleProxy = async (id, currentEnabled) => {
    try {
...
Lỗi: ${result.error}`);
      ...
      console.error("Lỗi test proxy:", error2);
...
Lỗi: ${result.error}`);
      ...
      console.error("Lỗi import:", error2);
  ...
  const handleExport = async () => {
    try {
      ...
      console.error("Lỗi export:", error2);
  ...
  const handleResetAll = async () => {
    ...
    try {
      ...
      console.error("Lỗi reset:", error2);
  ...
  const handleBulkImport = async () => {
    try {
      ...
      const result = await window.electronAPI.invoke("proxy:bulkImportWebshare", bulkImportText);
      if (result.success) {
        alert(`✅ Import thành công!
...
Lỗi: ${result.error}`);
      ...
      console.error("Lỗi bulk import:", error2);
      alert("Lỗi import proxies!");
    }
  };
  const handleQuickAddWebshare = async () => {
    try {
      const result = await window.electronAPI.invoke("proxy:quickAddWebshare");
      if (result.success) {
...
(10 free proxies từ tài khoản qfdakzos)`);
      ...
      console.error("Lỗi quick add:", error2);
