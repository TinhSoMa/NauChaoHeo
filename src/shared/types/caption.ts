...
export interface TranslationOptions {
  ...
  translateMethod?: 'api' | 'impit' | 'gemini_webapi_queue' | 'grok_ui' | 'openrouter' | 'deepseek'; // Phương thức dịch (default: 'api')
...
export interface TranslationBatchReport {
  ...
  endedAt?: number;
  durationMs?: number;
  transport?: 'api' | 'impit' | 'gemini_webapi_queue' | 'grok_ui' | 'openrouter' | 'deepseek';
  resourceId?: string;
