...
export interface TranslationOptions {
  ...
  translateMethod?: TranslationTransport; // Phương thức dịch (default: 'api')
...
export interface SingleBatchOptions {
  ...
  translateMethod?: TranslationTransport;
  projectId?: string;
  sourcePath?: string;
  runId?: string;
}
...
export interface TTSOptions {
  ...
  edgeWorkerEngine?: 'python' | 'go' | 'auto'; // Chọn worker Edge TTS ưu tiên từ UI/env
...
export type TranslationTransport = 'api' | 'impit' | 'gemini_webapi_queue' | 'grok_ui' | 'openrouter' | 'cli_agent';
